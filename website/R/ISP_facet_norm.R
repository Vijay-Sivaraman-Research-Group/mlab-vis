...
#
# Output:
#   1. Normalised speed scatter plot facet by (month,day) for a particular year,month (user input) with line representing median aggregated by hour
#   2. Raw speed scatter plot facet by (month,hour) for a particular year,month (user input) with line representing median aggregated by day
#
##########################################################################################################################################################
...
graph_name = paste("plot__",top_ten_households$year,"_",top_ten_households$month, "__","norm__facet(month,day)_hour_speed_IPaddress","__", top_ten_households$ISP,"____" , sep="")
ggplot_ISP  <- ggplot(top_ten_households, aes(x= hour, y = download_speed_normalised_month, color = IP_address, shape = IP_address)) + 
    geom_point() + 
    ...
    ggtitle(graph_name)+
    theme_bw()
savefileName = paste("plot__",top_ten_households$year,"_",top_ten_households$month, "__","norm__facet(month,day)_hour_speed_IPaddress","__", top_ten_households$ISP,"____",".png" , sep="")
...
graph_name = paste("plot__",top_ten_households$year,"_",top_ten_households$month, "__","norm__facet(month,hour)_day_speed_IPaddress","__", top_ten_households$ISP,"____" , sep="")
ggplot_ISP  <- ggplot(top_ten_households, aes(x= day, y = download_speed_normalised_month, color = IP_address, shape = IP_address)) + 
  geom_point() + 
  ...
  ggtitle(graph_name)+
  theme_bw()
savefileName = paste("plot__",top_ten_households$year,"_",top_ten_households$month, "__","norm__facet(month,hour)_day_speed_IPaddress","__", top_ten_households$ISP,"____",".png" , sep="")
ggsave(filename=savefileName, plot=ggplot_ISP, path = dest_path, width = 10, height = 6)
